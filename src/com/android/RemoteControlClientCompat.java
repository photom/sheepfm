...
public class RemoteControlClientCompat {
	...
	public static int FLAG_KEY_MEDIA_NEXT=0;
	public static int FLAG_KEY_MEDIA_STOP=0;
	public static int PLAYSTATE_PLAYING=0;
	public static int PLAYSTATE_STOPPED = 0;
	public static int FLAG_KEY_MEDIA_PLAY = 0;
	public static int FLAG_KEY_MEDIA_PAUSE = 0;
    ...
    public static boolean hasRemoteControlApis() {
