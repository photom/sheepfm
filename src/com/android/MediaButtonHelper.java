...
public class MediaButtonHelper {
    ...
    public static ComponentName getComponentName(Context context, Class<? extends BroadcastReceiver> klass) {
        if (RemoteControlClientCompat.hasRemoteControlApis()) {
        	return new ComponentName(context, klass);
        } else {
        	return new ComponentName(context.getPackageName(), klass.getName());
        }
    }
