...
public abstract class Radio {
	...
	public int tune(String appPath) throws IOException{
		...
		post.append("method=radio.tune&").
		     ...
		     append("api_sig=").append(Auth.getApiSignatureRadiotune(appPath, getStation())).append("&").
		     append("sk=").append( Auth.getSessionkey(appPath));
	...
	public int fetchList(String appPath) throws IOException {
		...
		post.append("method=radio.getPlaylist&").
		     append("api_key=").append(Auth.LASTFM_API_KEY).append("&").
		     append("api_sig=").append(Auth.getApiSignaturePlaylist(appPath)).append("&").
