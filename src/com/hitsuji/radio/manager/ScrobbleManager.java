...
public class ScrobbleManager extends IntentService {
	...
	private void scrobble(Intent intent){
		...
		String url = Radio.getRadioUrl(this.getFilesDir().getAbsolutePath());
		if (url==null) return;
		...
		track.toFile(this.getFilesDir().getAbsolutePath());
		StringBuffer post = new StringBuffer(); 
		List<String> sigArr = new ArrayList<String>();

		File dir = new File(this.getFilesDir().getAbsolutePath() + File.separator + Track.DIR);
		...
		String sig = Auth.getApiSignatureScrobble(appPath, sigArr);
