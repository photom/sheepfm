...
public class PlayingActivity extends FragmentActivity  {
	...
	public void goBack(int msec){
		Message msg = Message.obtain(mHandler, GOBACK);
		this.mHandler.sendMessageDelayed(msg, msec);
	}
	public void goBack(){
		Log.d(TAG, "do goback");
		Intent intent = null;
