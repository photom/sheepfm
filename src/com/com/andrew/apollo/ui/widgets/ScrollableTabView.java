...
ViewPager.OnPageChangeListener {
	...
	private final int mDividerColor = Color.BLACK;
	...
	private PlayingActivity mParent;
	...
	public void setParent(PlayingActivity pa){
		mParent = pa;
	}
	...
	public void onPageScrollStateChanged(int state) {
		Log.d(TAG, "onpagescrollstatechanged state:"+state + " current:"+this.mCurrentPage);
		if (this.mParent!=null)
			if ((mPrevPage==-1 && mCurrentPage == 1 && state == 0) ||
				(mPrevPage==0  && mCurrentPage == 1 && state == 0)) {
			mPrevPage = -1;
			mCurrentPage = -1;
			this.mParent.goBack(150);
		}
