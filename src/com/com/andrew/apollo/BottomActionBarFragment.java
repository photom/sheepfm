...
public class BottomActionBarFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mBottomActionBar.setBackgroundColor(Color.BLACK);
		final BottomActionBarItem love = (BottomActionBarItem)root.findViewById(R.id.heart_img);

		love.setScaleType(ScaleType.FIT_CENTER);
		...
		dislike.setScaleType(ScaleType.FIT_CENTER);
		...
		stop.setScaleType(ScaleType.FIT_CENTER);
		...
		next.setScaleType(ScaleType.FIT_CENTER);
