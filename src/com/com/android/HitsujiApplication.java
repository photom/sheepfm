...
public class HitsujiApplication extends Application {
    ...
    public void onCreate() {
        ...
        File dir = new File(this.getApplicationContext().getExternalFilesDir(null)+File.separator+ "cache");
        if (!dir.exists())dir.mkdirs();
        Caller.getInstance().setCache(new  FileSystemCache(dir));
        
        Track.removeOldArtistDir(this.getApplicationContext().getExternalFilesDir(null));
